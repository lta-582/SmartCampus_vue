...
<template>
  <div>
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>校园通知</el-breadcrumb-item>
    </el-breadcrumb>
  <el-form>
    <el-form-item>
        <el-button size="small" type="primary" icon="el-icon-plus" @click="handleEdit()">发布通知内容</el-button>
      </el-form-item>
    </el-form>
    <!--列表-->
    <el-table size="small" @selection-change="selectChange" :data="sActiveData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%; margin-top: 20px;">
      ...
      <el-table-column align="center" sortable prop="title" label="标题" width="140">
      </el-table-column>
      <el-table-column align="center" sortable prop="contentText" label="文章内容" width="500">
      </el-table-column>
      <el-table-column align="center" sortable prop="imagePath" label="图片" width="140">
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click='closeDialog("edit")'>
      <el-form label-width="80px" ref="editForm" :model="editForm" :rules="rules">
        <el-form-item label="文章Id" prop="articleId">
          <el-input :disabled="true" size="small" v-model="editForm.articleId" auto-complete="off" placeholder=""></el-input>
        </el-form-item>
        ...
        <el-form-item label="文章内容" prop="contentText">
          <el-input type="textarea" autosize v-model="editForm.contentText" auto-complete="off" placeholder="请输入文章内容"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    getdata(parameter) {
       ...
       */
      // 获取文章列表
      sActiveList(parameter).then(res => {
        this.loading = false
        console.log(res);
        if (res.ok == false) {
          this.$message({
